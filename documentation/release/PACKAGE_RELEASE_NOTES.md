...
- `resource.images.saile` (**sArtwork**) com nove artes fixas (5 comuns + 4 sTv).
- `script.module.saile.core` (**sCore**) com artwork, notificações, caminhos, erros e capacidades.
...
- Suíte com 77 testes unitários cobrindo persistência, clientes, contratos, roteamento, EPG e core.
...
- `script.module.saile.epg` (**sEPG**) independente, com XMLTV autorizado, UTC e cache próprio.
