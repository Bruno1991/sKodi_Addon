...
**Status do Projeto:** Implementado, sincronizado e validado no host e no Kodi (sTv v0.8.1, sEPG v1.3.2)
...
| :--- | :--- | :--- | :--- |
| **`plugin.video.stv`** | **sTv** | `0.8.1` | Add-on IPTV/Xtream com navegação de canais ao vivo por categorias nativas, auto-atualização silenciosa do EPG em segundo plano com TTL configurável, resolução de guia em lote no SQLite e InfoWall 54. |
...
- **Testes Unitários:** 86/86 testes aprovados no host.
